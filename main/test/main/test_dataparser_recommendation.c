 ...
 * @brief Unity tests for DataParser recommendation parsing.
 *
 * @ingroup DataParser
 */
...
/**
 * @brief Keeps the test translation unit linked.
 */
...
/**
 * @brief Verifies that valid recommendation JSON is parsed into the list.
 */
...
/**
 * @brief Verifies that an empty recommendation array is rejected.
 */
